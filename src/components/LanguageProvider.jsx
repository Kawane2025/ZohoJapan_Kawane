...
const content = {
  ...
  hero_desc: { ja:'コミュニティイベント、ワークショップ、地域連携のご案内。', en:'Join our community events, workshops, and local initiatives.' },
  ...
  reg_desc: { ja:'下記フォームにご入力ください。', en:'Fill out the form to secure your spot.' },
  name: { ja:'お名前', en:'Name' },
  ...
  thanks_title: { ja:'お申込みありがとうございました！', en:'Thank you for your registration!' },
  thanks_desc: { ja:'担当者よりご連絡いたします。', en:'We will contact you shortly.' },
  ...
  footer_more_zoho: { ja:'Zohoについてもっと知る', en:'Learn More about Zoho' },
}
...
export const LanguageProvider = ({children}) => {
  ...
  const t = useMemo(() => (key) => { const node = content[key]; return node?.[language] ?? node?.en ?? key }, [language])
